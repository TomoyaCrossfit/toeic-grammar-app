...
const P6_PASSAGES = [
  {
    ...
    passageTranslation: `宛先：s.carter@globalimports.com\n送信元：d.park@fastship-logistics.com\n日付：9月12日\n件名：荷物のアップデート（#FS-2891）\n\nカーター様、\n\nこのたびは、最近のご注文の処理に予期せぬ遅延が生じましたことをお知らせするためにご連絡いたします。東海岸の施設に影響を及ぼした悪天候により、主要な配送センターは縮小した能力で運営されておりました。\n\n状況はまもなく解決されることをお約束申し上げます。新しい配達予定日は9月22日となります。ご不便をおかけしたことへの補償として、追加料金なしで速達配送にアップグレードいたしました。\n\nこの件によるご不便を心よりお詫び申し上げるとともに、引き続きFastShip Logisticsをご利用いただいていることに感謝申し上げます。\n\n敬具\nデイビッド・パーク\nカスタマーリレーションズマネージャー、FastShip Logistics`
  },
  {
    _id: 'p6_b1',
    type: 'Notice',
    ...
    passageTranslation: `全スタッフへのお知らせ\nRidgeline Technologies — 施設管理部\n\n4階の会議室は11月4日から18日まで大規模な改装工事が行われます。この期間中、全スタッフは代わりに2階の会議施設をご利用いただくようお願いします。\n\nスケジュールの競合を避けるため、スペースは事前に予約することをお勧めします。代替会議スペースの予約は、社内イントラネットの「施設」タブから行うことができます。\n\n改装期間中に4階の会議室で予定されている会議は、すべて代替の場所に移動する必要があります。会議の日程変更にご支援が必要な場合は、施設チームの内線4400までご連絡ください。\n\nご協力いただきありがとうございます。ご不便をおかけすることをお詫び申し上げます。`
  },
  {
    _id: 'p6_b2',
    ...
    passageTranslation: `10月8日\n\nローラ・ヘンドリックス様\nビジネス開発ディレクター\nApex Solutions Inc.\n\nヘンドリックス様、\n\n先月の、両社間の潜在的な提携に関するミーティングのフォローアップとしてご連絡いたします。当社のサービスはApexの戦略的目標と密接に一致していると考えており、協力関係が双方にとって有益なものになると確信しております。\n\nご説明した通り、当社の独自プラットフォームは金融サービスセクターのクライアントに対して定量的な成果をすでに示しており、平均23%の生産性向上を達成しております。\n\n一方、ご参考までに最新の製品パンフレットを添付いたしました。貴社チームのご都合に合わせて、オフィスでのデモンストレーションも喜んでご手配いたします。下記の番号まで直接ご連絡ください。\n\nご連絡をお待ちしております。\n\n敬具\nジェームズ・ホワイトフィールド\nCEO、NovaTech Systems`
  },
];
